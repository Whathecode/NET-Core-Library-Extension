...
{
	/// <summary>
	/// Unit tests for <see href="Mathelper{T}" />.
	/// </summary>
	public class MathHelperTest
	{
		...
		{
			Assert.Equal( roundDownResult, MathHelper<T>.RoundToNearest( toRoundDown, factor ) );
			Assert.Equal( roundUpResult, MathHelper<T>.RoundToNearest( toRoundUp, factor ) );
		}
	}
}
